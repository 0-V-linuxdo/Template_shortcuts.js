// ==UserScript==
// @name         [Template] 快捷键跳转 [20260409] v1.6.9
// @namespace    https://github.com/0-V-linuxdo/Template_shortcuts.js
// @version      [20260409] v1.6.9
// @update-log   1.6.9: QuickInput 为“触发快捷键”恢复“(可选)”提示。
...
(() => {
  ...
  function safeQuerySelector2(root, selector) {
    const base = root && typeof root.querySelector === "function" ? root : globalThis.document || null;
  ...
  function safeQuerySelectorAll(root, selector) {
    const base = root && typeof root.querySelectorAll === "function" ? root : globalThis.document || null;
  ...
  var TRUSTED_TYPES_POLICY_NAME = "ShortcutTemplateTrustedHTML";
  var trustedHtmlPolicy = null;
  function getTrustedHtmlPolicy() {
    if (trustedHtmlPolicy) return trustedHtmlPolicy;
    try {
      if (!globalThis.trustedTypes || typeof globalThis.trustedTypes.createPolicy !== "function") return null;
      trustedHtmlPolicy = globalThis.trustedTypes.createPolicy(TRUSTED_TYPES_POLICY_NAME, {
  ...
  function setTrustedHTML(element, html) {
    ...
    try {
      ...
      const fragment = globalThis.document?.createDocumentFragment?.() || null;
  ...
  // src/modules/core/engine/action-registry.js
  ...
  // src/modules/core/utils/events.js
  ...
  // src/modules/core/engine/builtin-actions.js
  function createBuiltinActionTools(ctx = {}) {
    ...
    function resolveTemplateUrl(targetUrl) {
      ...
      if (String(targetUrl || "").includes(placeholder)) {
        ...
        if (keyword !== null && keyword !== void 0) {
    ...
    function clickElement(selector) {
      ...
      if (ok) return;
      const fallbackTarget = typeof element.closest === "function" ? element.closest('button, a, [role="button"], [onclick]') || element : element;
      try {
    ...
    function simulateKeystroke2(keyString) {
      if (!keyString) return;
    ...
    return Object.freeze({
      ...
      jumpToUrl,
      clickElement,
      simulateKeystroke: simulateKeystroke2
    });
  }

  // src/modules/core/engine/hotkeys.js
  var HOTKEY_MODIFIER_ORDER = Object.freeze(["CTRL", "SHIFT", "ALT", "CMD"]);
  var HOTKEY_MODIFIER_ALIASES = Object.freeze({
    CTRL: "CTRL",
    CONTROL: "CTRL",
    SHIFT: "SHIFT",
    ALT: "ALT",
  ...
  var HOTKEY_MODIFIER_DISPLAY = Object.freeze({
    CTRL: "Ctrl",
    SHIFT: "Shift",
    ALT: "Alt",
    CMD: "Cmd"
  });
  var SHIFTED_SYMBOL_TO_BASE_KEY = Object.freeze({
    "!": "1",
    "@": "2",
    "#": "3",
    "$": "4",
  ...
  var HOTKEY_STANDARD_DISPLAY_MAP = (() => {
  ...
  var KEY_EVENT_MAP = (() => {
    const map = /* @__PURE__ */ Object.create(null);
    const add = (standard, key, code) => {
      map[standard] = { key, code };
    };
  ...
  function formatHotkeyForDisplay(hotkeyStr) {
    ...
    return parts.map((part) => HOTKEY_MODIFIER_ALIASES[part] ? formatHotkeyModifierToken(part) : formatHotkeyMainKeyDisplayToken(part)).join(" + ");
  }
  function createHotkeysToolkit() {
    function getKeyEventProps2(standardMainKey) {
    ...
    return Object.freeze({
      ...
      getKeyEventProps: getKeyEventProps2
    });
  }

  // src/modules/core/utils/svg.js
  var SVG_NAMESPACE = "http://www.w3.org/2000/svg";
  var SVG_DEFAULT_ICON_FILL_COLOR = "#000000";
  var SVG_DEFAULT_THEME_LIGHT_FILL_COLOR = "#111827";
  var SVG_DEFAULT_THEME_DARK_FILL_COLOR = "#F8FAFC";
  var SVG_THEME_FILL_CLASS_NAME = "st-theme-fill";
  var SVG_SAFE_COLOR_TOKEN_RE = /^(?:#[0-9a-fA-F]{3,8}|(?:rgb|hsl)a?\(\s*[-\d.%\s,]+\s*\)|[a-zA-Z]+)$/;
  var SVG_ATTR_NAME_RE = /^[A-Za-z_][\w:.-]*$/;
  var SVG_BLOCKED_ATTR_NAMES = /* @__PURE__ */ new Set(["href", "xlink:href", "src", "style"]);
  var SVG_ROOT_LOCKED_ATTR_NAMES = /* @__PURE__ */ new Set(["xmlns", "width", "height", "viewbox"]);
  var SVG_TAG_NAME_MAP = Object.freeze({
    path: "path",
    circle: "circle",
    rect: "rect",
    ellipse: "ellipse",
  ...
  var SVG_CONTAINER_TAG_KEYS = /* @__PURE__ */ new Set(["g", "defs", "clippath", "mask", "lineargradient", "radialgradient"]);
  var SVG_GLOBAL_ALLOWED_ATTR_NAMES = /* @__PURE__ */ new Set([
    "id",
    "class",
    "transform",
    "opacity",
  ...
  var SVG_ALLOWED_ATTR_NAMES_BY_TAG = Object.freeze({
    ...
    path: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "d", "pathlength"]),
    circle: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "cx", "cy", "r", "pathlength"]),
    rect: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "x", "y", "width", "height", "rx", "ry", "pathlength"]),
    ellipse: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "cx", "cy", "rx", "ry", "pathlength"]),
    line: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "x1", "y1", "x2", "y2", "pathlength"]),
    polyline: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "points", "pathlength"]),
    polygon: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "points", "pathlength"]),
    g: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES]),
    defs: /* @__PURE__ */ new Set(["id"]),
    clippath: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "clippathunits"]),
    ...
    stop: /* @__PURE__ */ new Set([...SVG_GLOBAL_ALLOWED_ATTR_NAMES, "offset", "stop-color", "stop-opacity"])
  });
  var SVG_REQUIRED_ATTR_RULES_BY_TAG = Object.freeze({
    path: Object.freeze({
  ...
  var SVG_VALUE_URL_ATTR_NAMES = /* @__PURE__ */ new Set(["fill", "stroke", "clip-path", "mask"]);
  var SVG_DEFAULT_VALIDATION_OPTIONS = Object.freeze({
    strictRequiredAttrs: false,
    allowExternalUrlRefs: false
  });
  var SVG_ISSUE_CACHE_MAX_SIZE = 500;
  var SVG_ISSUE_CACHE = /* @__PURE__ */ new Set();
  ...
  function mergeSvgClassNames2(baseClassName, appendClassName) {
    const tokens = `${String(baseClassName || "")} ${String(appendClassName || "")}`.split(/\s+/).map((part) => String(part || "").trim()).filter(Boolean);
  ...
  function normalizeSvgAttrs(raw, {
    ...
    for (const [nameRaw, valueRaw] of Object.entries(raw)) {
      ...
      if (valueRaw === null || valueRaw === void 0) continue;
  ...
  function buildSvgElementMarkup(item, depth = 0, {
    ...
    const childrenMarkup = childItems.map((child, index) => buildSvgElementMarkup(child, depth + 1, {
      onIssue,
      path: `${path}.${index}`,
      validationOptions
    })).join("");
    ...
    if (childrenMarkup) {
      ...
      return attrsMarkup ? `<${tagName} ${attrsMarkup}>${childrenMarkup}</${tagName}>` : `<${tagName}>${childrenMarkup}</${tagName}>`;
    }
    if (SVG_CONTAINER_TAG_KEYS.has(tagKey)) {
      reportSvgIssue(onIssue, {
        code: "emptyContainer",
  ...
  function buildSvgElementsIconDataUrl(elements, {
    ...
    const bodyMarkup = elementList.map((item, index) => buildSvgElementMarkup(item, 0, {
      onIssue,
      path: `root.${index}`,
      validationOptions
    })).join("");
  ...
  function buildPathsIconDataUrl(paths, {
    ...
    const elements = pathList.map((path, index) => {
      ...
      const attrs = prefersPathFill ? { ...fillColor ? { fill: fillColor } : {}, ...pathAttrs, d } : { ...pathAttrs, ...fillColor ? { fill: fillColor } : {}, d };
  ...
  function buildThemeAdaptivePathsIconDataUrl(paths, {
    ...
    const elements = pathList.map((path, index) => {
      ...
      if (!keepPathFill) {
        delete attrs.fill;
        attrs.class = mergeSvgClassNames2(attrs.class, SVG_THEME_FILL_CLASS_NAME);
      }
      return { tag: "path", attrs };
    }).filter(Boolean);
    const bodyMarkup = elements.map((item, index) => buildSvgElementMarkup(item, 0, {
      onIssue,
      path: `root.${index}`,
      validationOptions
    })).join("");
  ...
  // src/modules/core/engine/icons.js
  function createIconManager({
    ...
    const memoryMaxEntries = Number.isFinite(Number(cacheOptions.memoryMaxEntries)) ? Math.max(0, Number(cacheOptions.memoryMaxEntries)) : 200;
    const maxDataUrlChars = Number.isFinite(Number(cacheOptions.maxDataUrlChars)) ? Math.max(0, Number(cacheOptions.maxDataUrlChars)) : 18e4;
    const memoryCache = enableMemoryCache ? /* @__PURE__ */ new Map() : null;
    ...
    const themeLightFillColor = typeof normalizeSvgCssColorToken === "function" ? normalizeSvgCssColorToken(themeAdaptOptions.lightFillColor, "#111827") : String(themeAdaptOptions.lightFillColor || "").trim() || "#111827";
    ...
    function getCachedThemeAdaptiveIconDataURL(source) {
      ...
      if (stored && typeof stored === "object" && !Array.isArray(stored) && stored.source === input && typeof stored.adapted === "string" && stored.adapted) {
    ...
    function buildThemeAdaptiveSvgDataUrl(svgText) {
      ...
      const themeRootClass = typeof mergeSvgClassNames === "function" ? mergeSvgClassNames(root.getAttribute("class"), themeRootClassName) : mergeClassNames(root.getAttribute("class"), themeRootClassName);
  ...
  // src/modules/core/engine/ui-shared.js
  function createUiSharedLayer(ctx = {}) {
    ...
    function applyThemeCssVariables(isDark = state.isDarkMode) {
      ...
      const setVar = (name, value) => {
        try {
          root.style.setProperty(`--${prefix}-${name}`, String(value ?? ""));
        } catch {
        }
      };
  ...
  // src/modules/core/engine/keyboard.js
  function createKeyboardLayer(ctx = {}) {
    ...
    const allowedInputTags = Array.isArray(keyboardOptions.allowedInputTags) ? keyboardOptions.allowedInputTags.map((t) => String(t || "").toUpperCase()).filter(Boolean) : ["INPUT", "TEXTAREA", "SELECT"];
    const allowedInputTagSet = new Set(allowedInputTags);
    const allowContentEditable = keyboardOptions.allowContentEditable !== false;
    const blockUnlistedModifierShortcutsInInputsWhenPanelOpen = keyboardOptions.blockUnlistedModifierShortcutsInInputsWhenPanelOpen !== false;
    ...
    function defaultIsAllowedShortcut(e) {
      ...
      if (e.ctrlKey || e.metaKey) {
        ...
        if (key === "i" && e.shiftKey || key === "j" && e.shiftKey || key === "c" && e.shiftKey || key === "u") {
          return true;
        }
        if (key === "r" || key === "r" && e.shiftKey || key === "w" || key === "t" || key === "t" && e.shiftKey || key === "l" || key === "d" || key === "h" || key === "j" || key === "n" && e.shiftKey) {
          return true;
        }
      ...
      if (e.altKey) {
        if (["ArrowLeft", "ArrowRight"].includes(code) || key === "d" || key === "f4") {
          return true;
        }
      }
      if (code === "F11") {
...
${lines}${duplicates.length > 12 ? "\n..." : ""}`);
  ...
  // src/modules/panel/editor/url-method.js
  function panelCreateUrlMethodConfigUI(ctx, currentMethod = "current", currentAdvanced = "href") {
    const { URL_METHODS: URL_METHODS2, uiShared, state, options } = ctx;
    ...
    const methods = Object.entries(URL_METHODS2 || {}).map(([value, cfg]) => ({
      value,
    ...
    methods.forEach((method) => {
      ...
      radio.addEventListener("change", () => {
        if (radio.checked) {
          ...
          const defaultAdvanced = Object.keys(URL_METHODS2[method.value].options)[0];
    ...
    function updateAdvancedOptions() {
      ...
      const methodConfig = URL_METHODS2[selectedMethod];
      if (methodConfig) {
  ...
  // src/modules/panel/editor/fields.js
  ...
  // src/modules/panel/editor/icon-library.js
  ...
  function panelCreateEnhancedKeyboardCaptureInput(ctx, labelText, currentValue, {
    ...
    const capturedModifiers = /* @__PURE__ */ new Set();
    let capturedMainKey = "";
  ...
  // src/modules/panel/editor/index.js
  function panelOpenShortcutEditor(ctx, { item = null, index = -1, renderShortcutsList, updateStatsDisplay } = {}) {
    ...
    const { showAlert } = dialogs;
    const { autoResizeTextarea } = layout;
    const normalizeHotkey2 = core.normalizeHotkey;
    ...
    const initialDataAdapter = temp.actionType === "custom" ? getCustomActionDataAdapter(temp.customAction) : null;
    ...
    const applyIconAdaptiveHelpBtnVisual = () => {
      const shouldActive = iconAdaptiveHelpHover || iconAdaptiveTooltipPinned || iconAdaptiveTooltip.style.display === "block";
      ...
      iconAdaptiveHelpBtn.style.backgroundColor = shouldActive ? iconAdaptiveHintPalette.helpBgActive : iconAdaptiveHintPalette.helpBg;
    };
    ...
    confirmBtn.onclick = () => {
      ...
      if (normalized.icon && !normalized.iconDark && normalized.iconAdaptive && typeof ensureThemeAdaptiveIconStored === "function") {
    ...
    function closeEdit() {
      ...
      try {
        document.removeEventListener("pointerdown", handleIconAdaptiveDocPointerDown, true);
      } catch {
      }
      try {
        if (typeof destroyIconField === "function") destroyIconField();
      } catch {
      }
      try {
        if (typeof destroyIconLibrary === "function") destroyIconLibrary();
      } catch {
      }
      try {
        if (typeof destroySimulateKeysCapture === "function") destroySimulateKeysCapture();
      } catch {
      }
      try {
        if (typeof destroyHotkeyCapture === "function") destroyHotkeyCapture();
      } catch {
      }
  ...
  // src/modules/panel/settings/index.js
  function createSettingsPanelLayer(ctx = {}) {
    ...
    function getShortcutStats() {
      ...
      const stats = { total: 0, byType: /* @__PURE__ */ Object.create(null) };
    ...
    function getActionTypeMeta(actionType) {
      ...
      const builtin = meta && typeof meta.builtin === "boolean" ? meta.builtin : ["url", "selector", "simulate", "custom"].includes(type);
    ...
    function updateStatsDisplay() {
      ...
      if (existingStats) {
        if (typeof existingStats.__shortcutTemplateStatsCleanup === "function") {
          try {
            existingStats.__shortcutTemplateStatsCleanup();
          } catch {
          }
        }
    ...
    function openSettingsPanel() {
      ...
      requestAnimationFrame(() => {
        ...
        setTimeout(() => {
          ...
          state.destroyResponsiveListener = () => {
            try {
              destroyResponsiveListener && destroyResponsiveListener();
            } catch {
            }
          };
        }, 100);
...
${displayTargetText}`;
      ...
      function closePanel() {
        ...
        if (statsEl && typeof statsEl.__shortcutTemplateStatsCleanup === "function") {
          try {
            statsEl.__shortcutTemplateStatsCleanup();
          } catch {
          }
        }
        if (typeof state.currentEditCloser === "function") {
  ...
  // src/modules/core/engine/api.js
  ...
  // src/modules/core/engine/create-shortcut-engine.js
  function createShortcutEngine(userOptions = {}) {
    ...
    const fallbackUiPrefsKeyBase = typeof storageKeys.shortcuts === "string" && storageKeys.shortcuts.trim() ? storageKeys.shortcuts.trim() : idPrefix;
    ...
    storageKeys.uiPrefs = typeof rawUiPrefsKey === "string" && rawUiPrefsKey.trim() ? rawUiPrefsKey.trim() : fallbackUiPrefsKey;
    storageKeys.iconThemeAdapted = typeof rawIconThemeAdaptedKey === "string" && rawIconThemeAdaptedKey.trim() ? rawIconThemeAdaptedKey.trim() : fallbackIconThemeAdaptedKey;
    ...
    const GMX = typeof GM_xmlhttpRequest === "function" ? GM_xmlhttpRequest : typeof GM !== "undefined" && GM.xmlHttpRequest ? GM.xmlHttpRequest : null;
    ...
    function normalizeShortcut(raw) {
      ...
      return {
        ...
        simulateKeys: normalizeHotkey2(shortcut.simulateKeys || ""),
        customAction: shortcut.customAction || "",
        hotkey: normalizeHotkey2(shortcut.hotkey || ""),
        icon: shortcut.icon || "",
    ...
    function createCoreLayer() {
      let hotkeyIndex = /* @__PURE__ */ new Map();
      let coreApi = null;
  ...
  // src/modules/core/utils/shortcuts.js
  ...
  function resolveShortcutField(engine, matcher, field, fallback = "") {
    ...
    if (typeof matcher === "string") {
      ...
      shortcut = (id ? findShortcutById(engine, id) : null) || (key ? findShortcutByKey(engine, key) : null) || (name ? findShortcutByName(engine, name) : null);
    }
    const value = shortcut && typeof shortcut[field] === "string" ? shortcut[field].trim() : "";
    return value || fallback;
  }

  // src/modules/core/utils/one-step.js
  function createOneStepExecutor({ execAction, isOpenChecker = {}, timing = {} } = {}) {
    ...
    function resolvePrimaryStep(rule) {
      if (!rule) return null;
      return rule.primaryStep || rule.primaryActionKey || Array.isArray(rule.stepsIfOpen) && rule.stepsIfOpen[0] || Array.isArray(rule.stepsIfClosed) && rule.stepsIfClosed[rule.stepsIfClosed.length - 1] || null;
    }
  ...
  // src/modules/core/utils/menu.js
  function resolveSelectorListFromSpec(ctx, spec) {
    ...
    if (typeof spec === "object") {
      ...
      const selector = fromId || fromKey || fromName ? resolveShortcutField(ctx?.engine, { id: fromId, key: fromKey, name: fromName }, field, fallback) : fallback;
  ...
  function createMenuController(menuConfig = {}, { parent = null } = {}) {
    ...
    function getTriggerCandidateSet(ctx) {
      ...
      for (const rawSpec of specs) {
        ...
        const textMatch = spec.textMatch !== void 0 ? spec.textMatch : triggerConfig.textMatch ?? null;
    ...
    function getRootElement(ctx) {
      ...
      if (type === "arialabelledby") {
        ...
        const id2 = triggerEl.getAttribute && triggerEl.getAttribute("id");
        if (id2 && baseSelector) {
  ...
  // src/modules/quick-input/storage.js
  ...
  function claimUniqueImageName(rawName, usedNames, index = 0, { type = "" } = {}) {
    const registry = usedNames instanceof Set ? usedNames : /* @__PURE__ */ new Set();
  ...
  function normalizeImageFiles(value) {
    ...
    return Array.from(value || []).filter((file) => file && file instanceof File && String(file.type || "").startsWith("image/")).map((file, index) => {
  ...
  function loadConfig(storageKey, defaults) {
    ...
    const toolHotkeys = hasToolHotkeys || hasToolHotkey ? normalizeToolHotkeys(hasToolHotkeys ? raw.toolHotkeys : raw.toolHotkey) : normalizeToolHotkeys(base.toolHotkeys);
    const panelPos = (() => {
    ...
    return {
      ...
      stepDelayMs,
      stepDelayUnit: normalizeDelayUnit(raw.stepDelayUnit) || normalizeDelayUnit(base.stepDelayUnit) || inferDelayUnitFromMs(stepDelayMs),
      loopDelayMs,
      loopDelayUnit: normalizeDelayUnit(raw.loopDelayUnit) || normalizeDelayUnit(base.loopDelayUnit) || inferDelayUnitFromMs(loopDelayMs),
  ...
  function saveConfig(storageKey, cfg, defaults) {
    ...
    const newChatHotkey = typeof safe.newChatHotkey === "string" ? safe.newChatHotkey : typeof prev.newChatHotkey === "string" ? prev.newChatHotkey : base.newChatHotkey;
    const panelPos = (() => {
      const src = safe.panelPos && typeof safe.panelPos === "object" && !Array.isArray(safe.panelPos) ? safe.panelPos : prev.panelPos;
    ...
    const payload = {
      ...
      stepDelayMs,
      stepDelayUnit: normalizeDelayUnit(safe.stepDelayUnit) || normalizeDelayUnit(prev.stepDelayUnit) || normalizeDelayUnit(base.stepDelayUnit) || inferDelayUnitFromMs(stepDelayMs),
      loopDelayMs,
      loopDelayUnit: normalizeDelayUnit(safe.loopDelayUnit) || normalizeDelayUnit(prev.loopDelayUnit) || normalizeDelayUnit(base.loopDelayUnit) || inferDelayUnitFromMs(loopDelayMs),
  ...
  async function sleepWithCancel(totalMs, { shouldCancel = null, chunkMs = 160, runtime = null } = {}) {
    ...
    const now = typeof runtimeApi?.now === "function" ? () => runtimeApi.now() : () => Date.now();
    const waitIfPaused = typeof runtimeApi?.waitIfPaused === "function" ? runtimeApi.waitIfPaused.bind(runtimeApi) : null;
  ...
  async function waitForObservedState({
    ...
    const pollMs = Math.max(80, Number(pollFallbackMs) || 1e3);
  ...
  // src/modules/quick-input/dom.js
  function clampInt2(value, { min = 0, max = 9999, fallback = 0 } = {}) {
    const num = Number.parseInt(String(value ?? ""), 10);
    if (!Number.isFinite(num)) return fallback;
    return Math.min(max, Math.max(min, num));
  }
  ...
  function normalizeHotkeyFallback2(raw) {
    const cleaned = normalizeHotkeyString2(raw).toUpperCase();
    if (!cleaned) return "";
    const parts = cleaned.split("+").map((s) => s.trim()).filter(Boolean);
    if (parts.length === 0) return "";
    const modifiers = /* @__PURE__ */ new Set();
  ...
  async function focusComposer({ timeoutMs = 2500, intervalMs = 120, shouldCancel = null, shouldIgnore = null, runtime = null } = {}) {
    ...
    try {
      simulateClick(composer, { nativeFallback: true });
    } catch {
    }
  ...
  function dispatchPasteEvent(target, clipboardData) {
    ...
    if (clipboardData) {
      try {
        Object.defineProperty(evt, "clipboardData", { value: clipboardData, configurable: true });
      } catch {
      }
      try {
        Object.defineProperty(evt, "dataTransfer", { value: clipboardData, configurable: true });
      } catch {
      }
    }
    try {
  ...
  function dispatchBeforeInputFromPaste(target, dataTransfer) {
    ...
    if (!evt) {
      try {
        evt = new Event("beforeinput", init);
      } catch {
        evt = null;
      }
    }
    if (!evt) return false;
    try {
      Object.defineProperty(evt, "inputType", { value: "insertFromPaste", configurable: true });
    } catch {
    }
    if (dataTransfer) {
      try {
      ...
      try {
        Object.defineProperty(evt, "clipboardData", { value: dataTransfer, configurable: true });
      } catch {
      }
    }
    try {
  ...
  function collectFileInputsFromOpenShadows(rootEl, { maxHosts = 2e3, shouldIgnore = null } = {}) {
    const ignore = typeof shouldIgnore === "function" ? shouldIgnore : null;
    const results = [];
    const stack = [];
  ...
  function isInsideOverlayTree(target, overlayId) {
    ...
    while (node && !visited.has(node)) {
      ...
      let current = node;
      const chainVisited = /* @__PURE__ */ new Set();
  ...
  function createController(userOptions = {}) {
    ...
    function getPauseAwareNow() {
      ...
      const currentPauseDuration = paused && pauseStartedAtMs ? Math.max(0, wallNow - pauseStartedAtMs) : 0;
    ...
    function appendRuntimeLog(text, options2 = {}) {
      ...
      if (activeLoopLogBodyEl) {
        appendLoopLog(text, options2);
        return;
      }
      appendGlobalLog(text, options2);
    }
    ...
    function appendStatusLog(text, { level = "info", time = getLogTimestamp(), detail = "", collapsible = false, open: open2 = true } = {}) {
      if (!logEl) return;
      const lineEl = createStatusLogElement(text, { level, time, detail, collapsible, open: open2 });
      if (!lineEl) return;
    ...
    function normalizeLogGroupLabel(title) {
      ...
      if (!raw) return "";
      const stripped = raw.replace(/^[\s\-–—_·•|]+/, "").replace(/[\s\-–—_·•|]+$/, "").trim();
      return stripped || raw;
    }
    ...
    function appendConfigLogGroup(title, textOrRows, { level = "info", open: open2 = false } = {}) {
      if (!logEl) return;
      const group = createLogGroup(title, { variant: "config", open: open2 });
      if (!group?.groupEl || !group?.bodyEl) return;
      const detailEl = Array.isArray(textOrRows) ? createLogGroupDetailRowsElement(textOrRows, { level }) : createLogGroupDetailElement(textOrRows, { level });
    ...
    function appendLog(text, { level = "info", scope = "globalThis" } = {}) {
      const container = scope === "loop" ? activeLoopLogBodyEl || logEl : logEl;
      appendLogToContainer(container, text, { level });
    }
    function appendGlobalLog(text, options2 = {}) {
      appendLog(text, { ...options2 || {}, scope: "globalThis" });
    }
    function appendLoopLog(text, options2 = {}) {
      appendLog(text, { ...options2 || {}, scope: "loop" });
    }
    function clearLog() {
      if (!logEl) return;
      logEl.textContent = "";
    ...
    function setImageFiles(nextFiles, { draftEntries = null, skipDraftPersist = false } = {}) {
      ...
      if (imagePreviewListEl) {
        ...
        if (imageDropEl) {
          imageDropEl.textContent = hasItems ? labels.placeholders?.imageDropMore || DEFAULT_LABELS.placeholders.imageDropMore : labels.placeholders?.imageDrop || DEFAULT_LABELS.placeholders.imageDrop;
        }
        if (clearAllImagesBtnEl) {
    ...
    function extractImageFilesFromTransfer(dataTransfer) {
      ...
      const directFiles = Array.from(dataTransfer.files || []).filter(Boolean).filter((file) => String(file?.type || "").startsWith("image/"));
      if (directFiles.length) return directFiles;
      return Array.from(dataTransfer.items || []).filter((item) => item && item.kind === "file" && String(item.type || "").startsWith("image/")).map((item) => item.getAsFile?.()).filter(Boolean);
    }
    function transferHasImageFiles(dataTransfer) {
      ...
      return Array.from(dataTransfer.items || []).some(
        (item) => item && item.kind === "file" && String(item.type || "").startsWith("image/")
      );
    }
    ...
    function onPickFiles(fileList) {
      ...
      const msg = labels.messages?.imagesLoaded ? labels.messages.imagesLoaded(images.length, Math.round(kb), totalCount, renamedCount) : DEFAULT_LABELS.messages.imagesLoaded(images.length, Math.round(kb), totalCount, renamedCount);
    ...
    function readConfigFromUi() {
      ...
      const toolHotkeys = hotkeyInputs.map((input) => String(input?.value ?? "").trim()).filter(Boolean);
      return {
        toolHotkeys,
        toolHotkey: toolHotkeys[0] || "",
        newChatHotkey: getNewChatHotkeyConfigValueFromUi(),
        loopCount: clampInt2(loopEl?.value, { min: 1, max: 999, fallback: clampInt2(defaults.loopCount, { min: 1, max: 999, fallback: 1 }) }),
    ...
    function stopDrag() {
      ...
      if (dragRestore) {
        try {
          globalThis.document.body.style.userSelect = dragRestore.userSelect;
        } catch {
        }
        try {
          globalThis.document.body.style.cursor = dragRestore.cursor;
        } catch {
        }
        dragRestore = null;
      }
    ...
    function onDragPointerMove(e) {
      ...
      if (!dragMoved) {
        ...
        try {
          globalThis.document.body.style.cursor = "move";
        } catch {
        }
    ...
    async function transitionToNextLoop({ loopDelayMs, loopDelayUnit, newChatHotkey, shouldCancel, sendCompletedAtMs, runtime = null }) {
      ...
      if (delayMs > 0) {
        ...
        const waitingMsg = labels.messages?.loopDelayBeforeNewChat ? labels.messages.loopDelayBeforeNewChat(delayMs, formattedDelay) : DEFAULT_LABELS.messages.loopDelayBeforeNewChat ? DEFAULT_LABELS.messages.loopDelayBeforeNewChat(delayMs, formattedDelay) : "";
    ...
    async function runMacro({ sourceAction = "run" } = {}) {
      ...
      const toolHotkeys = Array.isArray(cfg.toolHotkeys) ? cfg.toolHotkeys.map((value) => String(value ?? "").trim()).filter(Boolean) : [];
      ...
      if (isReplayRun) {
        ...
        if (!replayTransition?.okNewChat) {
          const replayMsg = labels.messages?.replayNewChatTriggered ? labels.messages.replayNewChatTriggered(replayLabel, false) : DEFAULT_LABELS.messages.replayNewChatTriggered(replayLabel, false);
      ...
      async function verifyInputUrlReady(stageLabel = "") {
        ...
        const detail = verification && typeof verification === "object" && typeof verification.message === "string" ? verification.message.trim() : "";
      ...
      function buildImageReadyFailureDetail(readyState, expectedCount) {
        const direct = readyState && typeof readyState === "object" && typeof readyState.message === "string" ? readyState.message.trim() : "";
      ...
      async function waitForImagesReadyWithReset(composerEl, expectedCount) {
        ...
        while (true) {
          ...
          if (reason === "timeout" && resetAttempt < maxResetAttempts && adapter.clearAttachments && adapter.attachImages) {
            ...
            composerRef = await adapter.focusComposer({ timeoutMs: 6e3, intervalMs: 120, shouldCancel, runtime }) || composerRef;
            if (!composerRef) {
              return {
                ok: false,
                cancelled: !!cancelRun,
            ...
            if (!clearResult?.ok) {
              ...
              return {
                ...
                ready: clearResult,
                message: typeof clearResult?.message === "string" && clearResult.message.trim() ? clearResult.message.trim() : clearFailedMsg
              };
            }
          ...
          if (!repairResult?.ok) {
            return {
              ...
              composer: composerRef,
              ready: repairResult,
              message: typeof repairResult?.message === "string" && repairResult.message.trim() ? repairResult.message.trim() : buildImageReadyFailureDetail(ready, expected)
            };
          }
          const repairedMsg = labels.messages?.repairedImages ? labels.messages.repairedImages(repairFiles.length, expected) : DEFAULT_LABELS.messages.repairedImages(repairFiles.length, expected);
      ...
      for (let i = 0; i < cfg.loopCount; i++) {
        ...
        let composer = await adapter.focusComposer({ timeoutMs: 15e3, intervalMs: 160, shouldCancel, runtime });
        if (!composer) {
          if (cancelRun) {
            markRunCancelled();
            break;
        ...
        const sendMsg = labels.messages?.sendAttempted ? labels.messages.sendAttempted(okSend) : DEFAULT_LABELS.messages.sendAttempted(okSend);
      ...
      collapseOpenLoopLogGroups();
      clearActiveLoopLogTarget();
      const finalLevel = runFinalStatus === "failed" ? "error" : runFinalStatus === "cancelled" || cancelRun ? "warn" : "ok";
      const finalMessage = finalLevel === "error" ? labels.messages?.failed || DEFAULT_LABELS.messages.failed : finalLevel === "warn" ? labels.messages?.stopped || DEFAULT_LABELS.messages.stopped : labels.messages?.finished || DEFAULT_LABELS.messages.finished;
      const finalDetail = finalLevel === "warn" ? String(pendingFinalStatusDetail || "").trim() : "";
  ...
  var quick_input_default = quickInput;

  // src/modules/index.js
  var VERSION = TEMPLATE_VERSION;
  var ShortcutTemplate = Object.freeze({
    VERSION,
    URL_METHODS,
    createShortcutEngine,
    utils: utils_default,
    quickInput: quick_input_default
  });
  var modules_default = ShortcutTemplate;

  // src/userscript/entry.js
  globalThis.ShortcutTemplate = Object.freeze(modules_default);
})();
