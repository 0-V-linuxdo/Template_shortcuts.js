...
(function() {
    ...
    function getGrokDeleteConfirmText(engine, key, fallback) {
        return engine?.i18n?.t?.(`dialogs.deleteChatConfirm.${key}`, {}, fallback) || fallback;
    }

    function showGrokDeleteConfirmDialog({ engine = null } = {}) {
