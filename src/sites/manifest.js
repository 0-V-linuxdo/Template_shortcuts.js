...
export const SITE_MANIFEST = Object.freeze([
    {
        ...
        metadata: {
            name: "[ChatGPT] 快捷键跳转 [20260430] v1.1.4",
            ...
            version: "[20260430] v1.1.4",
            updateLog: "1.1.4: 同步 Template v1.1.4，美化快捷输入导入/导出按钮图标，增强复制/粘贴语义在小尺寸下的识别度。",
            localized: {
                "en-US": {
                    name: "[ChatGPT] Shortcut Jump [20260430] v1.1.4",
                    ...
                    updateLog: "1.1.4: Synced Template v1.1.4; refined Quick Input import/export icons to make copy/paste semantics clearer at small sizes."
                }
            },
            match: [
                "https://chatgpt.com/*"
