...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 优化 Gemini Extended 快捷键选择路径，避免模型选择器长时间停留，并更新为新的 Template core require。",
            localized: {
                "en-US": {
                    name: "[Gemini] Shortcut Jump [20260528] v1.0.0",
                    ...
                    updateLog: "1.0.0: Optimized the Gemini Extended shortcut selection path to avoid the model picker lingering and updated the script to require the new Template core."
                }
            },
            match: [
    ...
    },
    {
        ...
        metadata: {
            name: "[Notion] 快捷键跳转 [20260528] v1.0.0",
            namespace: "https://github.com/0-V-linuxdo/Template_shortcuts.js",
            ...
            version: "[20260528] v1.0.0",
            updateLog: "1.0.0: 修复 Notion QuickInput 重试时 URL 主页误判，只以 /ai 作为新聊天入口，并更新为新的 Template core require。",
            localized: {
                "en-US": {
                    name: "[Notion] Shortcut Jump [20260528] v1.0.0",
                    ...
                    updateLog: "1.0.0: Fixed the Notion QuickInput retry URL home-route false positive, uses /ai as the only new-chat entry, and updated the script to require the new Template core."
                }
            },
            match: [
                "https://*.notion.so/*",
