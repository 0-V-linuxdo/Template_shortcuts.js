...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.4: 修复默认 Expert 模式仍未生效的问题，经过控制台验证后改为对 DeepSeek 模式 radio 控件优先执行原生 click，再校验 aria-checked。",
            localized: {
                "en-US": {
                    name: "[DeepSeek] Shortcut Jump [20260520] v1.0.4",
                    ...
                    updateLog: "1.0.4: Fixed default Expert mode again after console verification by native-clicking DeepSeek mode radio controls before checking aria-checked."
                }
            },
            match: [
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.2: 修复 Gemini 新 UI 左侧当前话题三点按钮识别；顶部当前会话菜单仍优先，缺失或不可用时会临时展开侧栏并回退到当前话题菜单。",
            localized: {
                "en-US": {
                    name: "[Gemini] Shortcut Jump [20260520] v1.0.2",
                    ...
                    updateLog: "1.0.2: Fixed Gemini new UI detection for the left-sidebar current-topic three-dot button; the top current-conversation menu is still preferred, and when missing or unavailable the shortcut temporarily expands the sidebar and falls back to the current-topic menu."
                }
            },
            match: [
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.6: 新增 Notion AI 删除话题快捷键，优先点击右上角三点菜单并执行 Delete；同时保留原生确认框，不自动确认删除。",
            localized: {
                "en-US": {
                    name: "[Notion] Shortcut Jump [20260518] v1.0.6",
                    ...
                    updateLog: "1.0.6: Added a Notion AI delete-topic shortcut that opens the conversation menu, clicks Delete, and leaves any native confirmation dialog untouched."
                }
            },
            match: [
                "https://*.notion.so/*",
