...
export const SITE_MANIFEST = Object.freeze([
    {
        ...
        metadata: {
            ...
            updateLog: "1.1.1: 更新 Template core require；QuickInput 悬浮球左侧按钮可暂停/继续当前任务，右侧状态区域恢复弹窗。",
            localized: {
                "en-US": {
                    name: "[ChatGPT] Shortcut Jump [20260605] v1.1.1",
                    ...
                    updateLog: "1.1.1: Updated the Template core require; the QuickInput bubble's left button now pauses/resumes the current task, while the status area restores the popup."
                }
            },
            match: [
                "https://chatgpt.com/*"
    ...
    },
    {
        ...
        metadata: {
            name: "[Gemini] 快捷键跳转 [20260605] v1.1.1",
            namespace: "https://github.com/0-V-linuxdo/Template_shortcuts.js",
            ...
            localized: {
                "en-US": {
                    name: "[Gemini] Shortcut Jump [20260605] v1.1.1",
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 将 dairoot 镜像站 URL 迁移至 gk.dairoot.cn。",
            localized: {
                "en-US": {
                    name: "[Grok] Shortcut Jump [20260625] v1.0.0",
                    ...
                    updateLog: "1.0.0: Migrated the dairoot mirror URL to gk.dairoot.cn."
                }
            },
            match: [
                "https://gk.dairoot.cn/*",
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.1: 移除已失效的 Ki -Flag 默认快捷键，并将 Regenerate Last Message 的默认触发热键调整为 Ctrl+R，同时迁移旧默认配置。",
            localized: {
                "en-US": {
                    name: "[Kagi] Shortcut Jump [20260619] v1.0.1",
                    ...
                    updateLog: "1.0.1: Removed the now-invalid Ki -Flag default shortcut, changed Regenerate Last Message to default to Ctrl+R, and migrates old default settings."
                }
            },
            match: [
                "https://*.kagi.com/*"
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.1.1: 修复 Notion AI QuickInput 调用 Ctrl+R 成功后被脚本合成 Esc 误暂停的问题，并撤销上一版错误的 Research 模式确认逻辑调整。",
            localized: {
                "en-US": {
                    name: "[Notion AI] Shortcut Jump [20260623] v1.1.1",
                    ...
                    updateLog: "1.1.1: Fixed Notion AI QuickInput runs that invoke Ctrl+R successfully but pause after a script-dispatched Escape, and reverted the previous incorrect Research mode confirmation change."
                }
            },
            match: [
