...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 修复 Delete 快捷键打开删除确认框后 Enter 可能失效的问题；确认弹窗会重新定位最新 Delete 按钮，并在点击失败时允许再次按 Enter。",
            localized: {
                "en-US": {
                    ...
                    updateLog: "1.0.0: Fixed Delete shortcut confirmation where Enter could stop responding after opening Gemini's delete dialog; the bridge re-resolves the latest Delete button and allows another Enter after a failed click."
                }
            },
            match: [
