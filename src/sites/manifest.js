...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 修复 Research 模式快捷键，移除可能提交消息的 Enter fallback，仅在 Mode 子菜单内点击 Research，并在确认失败时阻断 QuickInput 发送。",
            localized: {
                "en-US": {
                    ...
                    updateLog: "1.0.0: Fixed the Research mode shortcut by removing Enter fallbacks that could submit messages, clicking Research only inside the Mode submenu, and blocking QuickInput send on confirmation failure."
                }
            },
            match: [
