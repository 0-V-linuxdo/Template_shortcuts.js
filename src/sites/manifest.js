...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 修复 Research 模式快捷键，按 Notion 当前 Settings > Mode > Research 菜单路径执行，增加菜单打开/点击 fallback、选中确认与 QuickInput 失败阶段诊断。",
            localized: {
                "en-US": {
                    ...
                    updateLog: "1.0.0: Fixed the Research mode shortcut against Notion's current Settings > Mode > Research menu path, adding menu open/click fallbacks, selection confirmation, and QuickInput failure-stage diagnostics."
                }
            },
            match: [
