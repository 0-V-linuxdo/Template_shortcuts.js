...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 配合 Template core 修复 custom action 异步等待链路，并让 Notion 模式切换在菜单关闭并稳定后才返回，避免 QuickInput 后续模型快捷键抢跑。",
            localized: {
                "en-US": {
                    ...
                    updateLog: "1.0.0: Paired with the Template core custom action async wait fix, and made Notion mode switching return only after the menu closes and settles so QuickInput model shortcuts do not run early."
                }
            },
            match: [
