...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.0.0: 修复 Research 模式快捷键改走 Notion 当前独立 Research 按钮路径，并配合 Template core 等待异步工具快捷键与当前 hotkey 重试暂停保护。",
            localized: {
                "en-US": {
                    ...
                    updateLog: "1.0.0: Routed the Research mode shortcut through Notion's current dedicated Research button, paired with Template core async tool shortcut waiting and current-hotkey retry/pause protection."
                }
            },
            match: [
