...
export const SITE_MANIFEST = Object.freeze([
    ...
    },
    {
        ...
        metadata: {
            ...
            updateLog: "1.1.9: 修复 Grok Delete Chat 菜单项层级识别，兼容 tabindex/li 菜单项，增强未激活判定，并将脚本确认弹窗默认焦点改为整个弹窗区域。",
            localized: {
                "en-US": {
                    name: "[Grok] Shortcut Jump [20260518] v1.1.9",
                    ...
                    updateLog: "1.1.9: Fixed Grok Delete Chat menu-item layer detection for tabindex/li menu entries, strengthened non-activation detection, and changed the script confirmation dialog to focus the whole dialog panel by default."
                }
            },
            match: [
