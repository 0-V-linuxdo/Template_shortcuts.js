...
export const SITE_MANIFEST = Object.freeze([
    {
        ...
        metadata: {
            ...
            updateLog: "1.1.4: 同步 Template v1.1.4，修正按键模拟类别图标对称性，并优化 Quick Input 键盘图标线条。",
            localized: {
                "en-US": {
                    name: "[ChatGPT] Shortcut Jump [20260429] v1.1.4",
                    ...
                    updateLog: "1.1.4: Synced Template v1.1.4 with symmetric key-simulation category icons and refined Quick Input keyboard icon strokes."
                }
            },
            match: [
                "https://chatgpt.com/*"
