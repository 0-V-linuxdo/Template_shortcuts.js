...
// @update-log:en  1.0.0: Refreshed the Template core require cache token, rendered adaptive SVGs inline from native web artwork, and published native icon sync plus light/dark visibility fixes for every Notion AI default shortcut.
