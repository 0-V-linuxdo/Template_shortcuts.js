// ==UserScript==
// @name           [Template] 快捷键跳转 [20260530] v1.0.1
// @name:en        [Template] Shortcut Core [20260530] v1.0.1
// @namespace      https://github.com/0-V-linuxdo/Template_shortcuts.js
// @version        [20260530] v1.0.1
// @update-log     1.0.1: 刷新 Template core require 缓存标记，配合 Notion Quick Input 空白 New Chat 页识别修复发布。
// @update-log:en  1.0.1: Refreshed the Template core require cache token for the Notion Quick Input blank new-chat page detection fix release.
