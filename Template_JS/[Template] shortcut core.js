...
// @update-log     1.0.0: 为模拟按键事件补充 composed 事件属性，使站点级弹窗监听能更稳定接收模拟 Enter。
// @update-log:en  1.0.0: Added the composed event flag to simulated keyboard events so site-level dialog listeners receive simulated Enter more reliably.
