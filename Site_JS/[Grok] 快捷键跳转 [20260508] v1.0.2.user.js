...
// @name:en        [Grok] Shortcut Jump [20260508] v1.0.2
...
// @update-log     1.0.2: 将 Grok 脚本图标内联到脚本头，普通模式使用黑色配色，黑暗模式使用白色配色。
// @update-log:en  1.0.2: Inlined the Grok script icon in the userscript header, using black in light mode and white in dark mode.
