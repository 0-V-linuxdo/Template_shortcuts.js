...
(() => {
    ...
    const MENU_PENDING_VALUE_KEY = "__templateShortcutsMenuPendingValue::bilibili";
    const MENU_PAGE_TOKEN_STORAGE_KEY = "__templateShortcutsMenuPageToken::bilibili";
