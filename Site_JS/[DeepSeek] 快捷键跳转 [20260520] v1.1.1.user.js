...
// @name:en        [DeepSeek] Shortcut Jump [20260520] v1.1.1
...
// @update-log     1.1.1: 修复 DeepSeek 默认快捷键 SVG 图标在深色面板中仍显示黑色的问题，为 New Chat/Search/DeepThink/Sidebar 默认图标启用普通/黑暗模式自适应迁移。
// @update-log:en  1.1.1: Fixed DeepSeek default shortcut SVG icons staying black in the dark settings panel by enabling light/dark adaptive migration for New Chat/Search/DeepThink/Sidebar default icons.
