...
// @name:en        [DeepSeek] Shortcut Jump [20260520] v1.1.0
...
// @update-log     1.1.0: 将新聊天改为映射 DeepSeek 网页原生 CMD+J 快捷键，移除冗余 selector/顶部图标/跳首页兜底，并更新默认新聊天图标。
// @update-log:en  1.1.0: Changed New Chat to map DeepSeek's native CMD+J shortcut, removed redundant selector/header-icon/home-route fallbacks, and refreshed the default New Chat icon.
