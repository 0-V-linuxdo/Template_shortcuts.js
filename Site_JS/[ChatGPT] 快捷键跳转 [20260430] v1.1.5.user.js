...
// @name:en        [ChatGPT] Shortcut Jump [20260430] v1.1.5
...
// @update-log     1.1.5: 同步 Template v1.1.5，回调快捷输入导入/导出按钮图标为更轻巧的视觉样式，改善小尺寸下的整体观感。
// @update-log:en  1.1.5: Synced Template v1.1.5; restored lighter Quick Input import/export icons for a cleaner small-size appearance.
