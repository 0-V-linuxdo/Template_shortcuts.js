...
// @name:en        [QuiverAI] Shortcut Jump [20260531] v1.0.2
...
// @update-log     1.0.2: 为 QuiverAI 脚本头补充键帽样式图标，内嵌 QuiverAI logo。
// @update-log:en  1.0.2: Added a keycap-style userscript header icon with the QuiverAI logo.
