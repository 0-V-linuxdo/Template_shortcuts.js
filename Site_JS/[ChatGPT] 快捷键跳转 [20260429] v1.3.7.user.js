...
// @name:en        [ChatGPT] Shortcut Jump [20260429] v1.3.7
...
// @update-log     1.3.7: 同步 Template v1.3.7，修复快捷输入“更多设置”展开后再折叠导致弹窗高度不回收、表单行距异常拉大的问题。
// @update-log:en  1.3.7: Synced Template v1.3.7; fixed Quick Input layout issues where collapsing More settings after expansion could leave the panel too tall and stretch form row spacing.
