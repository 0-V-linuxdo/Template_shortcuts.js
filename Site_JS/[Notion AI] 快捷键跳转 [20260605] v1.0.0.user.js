...
// @update-log     1.0.0: 修复 Research 模式快捷键：打开 Settings 后安全聚焦 Mode 菜单，并仅用 ArrowRight 打开 Mode 子菜单；QuickInput 未确认成功前不会发送。
// @update-log:en  1.0.0: Fixed the Research mode shortcut by safely focusing the Mode menu after opening Settings and using ArrowRight only to open the Mode submenu; QuickInput will not send until success is confirmed.
