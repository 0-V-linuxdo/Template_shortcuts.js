...
// @name:en        [DeepSeek] Shortcut Jump [20260508] v1.0.0
...
// @update-log     1.0.0: 保留原键帽样式，将 DeepSeek 脚本图标键帽改为普通模式黑色、黑暗模式白色自适应。
// @update-log:en  1.0.0: Kept the original keycap style and made the DeepSeek script icon keycap adapt to black in light mode and white in dark mode.
