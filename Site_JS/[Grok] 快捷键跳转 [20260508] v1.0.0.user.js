...
// @update-log     1.0.0: 显式保持 Grok 脚本图标键帽区域透明，普通模式使用黑色配色，黑暗模式使用白色配色。
// @update-log:en  1.0.0: Explicitly kept the Grok script icon keycap area transparent while using black in light mode and white in dark mode.
