...
// @update-log     1.0.0: 升级 ChatGPT 脚本图标，普通模式使用黑色配色，黑暗模式使用白色配色。
// @update-log:en  1.0.0: Updated the ChatGPT script icon to use black in light mode and white in dark mode.
