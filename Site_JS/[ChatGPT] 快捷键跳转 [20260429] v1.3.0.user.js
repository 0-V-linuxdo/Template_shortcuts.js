...
// @name:en        [ChatGPT] Shortcut Jump [20260429] v1.3.0
...
// @update-log     1.3.0: 同步 Template v1.3.0，快捷输入触发快捷键改为按动作与快捷键下拉选择，并兼容保留旧配置。
// @update-log:en  1.3.0: Synced Template v1.3.0; Quick Input trigger shortcuts now use action-and-hotkey dropdowns while preserving legacy saved values.
