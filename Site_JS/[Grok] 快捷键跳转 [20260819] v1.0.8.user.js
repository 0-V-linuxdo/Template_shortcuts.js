...
// @update-log     1.0.8: SPA 跳转改为先点站内链接，且不再对 Next.js 伪造 popstate，Imagine/Project 等不再整页刷新。
// @update-log:en  1.0.8: SPA jumps now click in-page links first and skip fake Next.js popstate, so Imagine/Project no longer hard-reload.
