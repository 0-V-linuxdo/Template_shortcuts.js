...
// @name:en        [ChatGPT] Shortcut Jump [20260430] v1.1.6
...
// @update-log     1.1.6: 同步 Template v1.1.6，优化快捷输入导入/导出按钮质感，提升圆形按钮的层次、主色呼应与悬停反馈。
// @update-log:en  1.1.6: Synced Template v1.1.6; polished Quick Input import/export button styling with richer circular surfaces, primary-color accents, and hover feedback.
