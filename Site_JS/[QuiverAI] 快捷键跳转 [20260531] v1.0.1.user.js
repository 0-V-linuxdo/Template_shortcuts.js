...
// @name:en        [QuiverAI] Shortcut Jump [20260531] v1.0.1
...
// @update-log     1.0.1: 将默认快捷键图标改为 QuiverAI 页面原生 lucide 图标，并自动迁移旧默认图标。
// @update-log:en  1.0.1: Changed the default shortcut icons to QuiverAI's native lucide icons and automatically migrates the old default icons.
