...
// @name:en        [ChatGPT] Shortcut Jump [20260430] v1.1.2
...
// @update-log     1.1.2: 同步 Template v1.1.2，重做快捷输入导入/导出按钮图标，移除上传/下载方向箭头，改为更直观的复制/粘贴语义。
// @update-log:en  1.1.2: Synced Template v1.1.2; redesigned Quick Input import/export icons by removing upload/download arrows and using clearer copy/paste semantics.
