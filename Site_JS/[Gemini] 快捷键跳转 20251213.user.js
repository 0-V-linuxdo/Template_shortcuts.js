...
(() => {
    ...
    const MENU_PENDING_VALUE_KEY = "__templateShortcutsMenuPendingValue::gemini";
    const MENU_PAGE_TOKEN_STORAGE_KEY = "__templateShortcutsMenuPageToken::gemini";
