...
// @name:en        [ChatGPT] Shortcut Jump [20260429] v1.2.1
...
// @update-log     1.2.1: 同步 Template v1.2.1，优化设置菜单重置图标与按钮布局，并让语言下拉固定语言使用对应语言名称显示。
// @update-log:en  1.2.1: Synced Template v1.2.1 with reset icon and action layout refinements, plus self-labeled fixed language choices.
