...
// @name:en        [Notion AI] Shortcut Jump [20260531] v1.1.0
...
// @update-log     1.1.0: 将 Notion AI 脚本图标改为自适应键帽与 Notion AI logo，普通模式黑色、黑暗模式白色。
// @update-log:en  1.1.0: Updated the Notion AI script icon to an adaptive keycap with the Notion AI logo, using black in light mode and white in dark mode.
