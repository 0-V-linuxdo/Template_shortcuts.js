// ==UserScript==
// @name           [Gemini] 快捷键跳转 [20260511] v1.1.0
// @name:en        [Gemini] Shortcut Jump [20260511] v1.1.0
...
// @update-log     1.1.0: 让 Delete 确认弹窗支持 Enter / NumpadEnter 确认，减少必须鼠标点击的情况。
// @update-log:en  1.1.0: Made Delete confirmation dialogs accept Enter / NumpadEnter, reducing the need for mouse clicks.
    ...
    function createGeminiQuickInputAdapter({ idPrefix = "gemini", engine: engine2 = null } = {}) {
      ...
      async function tryInsertTextIntoGeminiComposerViaExecCommand(composerEl, text) {
        ...
        for (const chunk of splitGeminiTextIntoChunks(plainText)) {
          ...
          await sleep2(GEMINI_TEXT_INSERT_CHUNK_DELAY_MS);
