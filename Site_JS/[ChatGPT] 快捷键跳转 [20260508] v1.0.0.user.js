...
// @update-log     1.0.0: 改用无填充描边键帽，确保脚本图标键帽区域透明，并保持普通模式黑色、黑暗模式白色。
// @update-log:en  1.0.0: Switched the script icon keycap to a no-fill stroke so the keycap area stays transparent while using black in light mode and white in dark mode.
