...
(() => {
    ...
    const SITE_LABEL = "[DeepSeek] 快捷键跳转";
    ...
    const MENU_PENDING_VALUE_KEY = "__templateShortcutsMenuPendingValue::deepseek";
    const MENU_PAGE_TOKEN_STORAGE_KEY = "__templateShortcutsMenuPageToken::deepseek";
