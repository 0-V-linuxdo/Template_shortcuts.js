...
// @update-log     1.0.0: 保留原键帽样式，将 Perplexity 脚本图标内联到脚本头，普通模式使用黑色配色，黑暗模式使用白色配色。
// @update-log:en  1.0.0: Kept the original keycap style, inlined the Perplexity script icon in the userscript header, and used black in light mode and white in dark mode.
