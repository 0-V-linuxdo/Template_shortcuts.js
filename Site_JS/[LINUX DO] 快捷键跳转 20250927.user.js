...
(() => {
    ...
    const SITE_ID = "linux-do";
    const SITE_LABEL = "[LINUX DO] 快捷键跳转";
    ...
    const MENU_PENDING_STORAGE_KEY = "__templateShortcutsMenuPending::linux-do";
    const MENU_READY_STORAGE_KEY = "__templateShortcutsMenuReady::linux-do";
