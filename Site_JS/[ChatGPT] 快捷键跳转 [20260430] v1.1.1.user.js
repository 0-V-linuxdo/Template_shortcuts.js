...
// @name:en        [ChatGPT] Shortcut Jump [20260430] v1.1.1
...
// @update-log     1.1.1: 同步 Template v1.1.1，优化快捷输入导入/导出按钮图标，改为更清晰的剪贴板语义图标且保持纯图标显示。
// @update-log:en  1.1.1: Synced Template v1.1.1; improved Quick Input import/export buttons with clearer clipboard-style icons while keeping icon-only controls.
