...
(() => {
    ...
    const MENU_PENDING_VALUE_KEY = "__templateShortcutsMenuPendingValue::grok";
    const MENU_PAGE_TOKEN_STORAGE_KEY = "__templateShortcutsMenuPageToken::grok";
