...
// @name:en        [ChatGPT] Shortcut Jump [20260429] v1.3.1
...
// @update-log     1.3.1: 同步 Template v1.3.1，快捷输入默认步骤/循环间隔调整为 1 秒/20 秒，并将触发快捷键下拉选项改为“快捷键 名称”显示。
// @update-log:en  1.3.1: Synced Template v1.3.1; Quick Input defaults now use 1s/20s step and loop delays, and trigger shortcut options display as "shortcut name".
